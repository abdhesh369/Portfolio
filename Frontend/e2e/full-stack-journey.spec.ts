...
test.describe('Full-Stack Journey (Layer 3)', () => {
    const ADMIN_PASSWORD = '1111111111111111';
    ...
    test('should allow admin to login and create a project that appears publicly', async ({ page }) => {
        ...
        console.log('[E2E] Logged in, waiting for dashboard...');
        await page.waitForURL('**/admin', { timeout: 20000 });
        await expect(page).toHaveURL(/\/admin/);

        // 2. Navigate to Projects tab
        console.log('[E2E] Navigating to Projects tab...');
        ...
        console.log('[E2E] Clicking Add button...');
        ...
        // 4. Fill Project Form
        console.log('[E2E] Filling project form...');
        ...
        console.log('[E2E] \u2705 Full-stack journey successful!');
    });
});
