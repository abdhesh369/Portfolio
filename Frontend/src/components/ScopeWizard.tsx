                ...
                return (
                    <m.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">What should we call this mission?</p>
                        </div>
                        <div className="space-y-4">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-foreground/5 border border-border rounded-lg px-4 py-3 text-foreground outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all font-mono"
                                />
                            </div>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            formData.projectType === type
                                                ...
                                                : "bg-foreground/5 border-border text-muted-foreground hover:border-foreground/30"
                                        )}
                                    >
                                        {type}
                                    </button>
                ...
                return (
                    <m.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Describe the core problem you're solving.</p>
                        </div>
                        <textarea
                            placeholder="Detailed requirements, user stories, or technical constraints..."
                            value={formData.description}
                            onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                            className="w-full bg-foreground/5 border border-border rounded-lg px-4 py-3 text-foreground outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all font-mono min-h-[200px] resize-none"
                        />
                    </m.div>
                );
            case 3:
                return (
                    <m.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Select the core modules required for the build.</p>
                        </div>
                ...
                return (
                    <m.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Where should I send the final detailed analysis?</p>
                        </div>
                        <div className="space-y-4">
                            <input
                                type="text"
                        ...
                        <div className="text-center space-y-4">
                            {status !== "completed" && status !== "failed" ? (
                                <>
                                    ...
                                    <h3 className="text-xl font-bold text-foreground font-mono animate-pulse">
                            ...
                            {status === "failed" || streamError ? (
                                <div className="space-y-4 py-8">
                                    ...
                                    <h3 className="text-xl font-bold text-foreground">Analysis Terminated</h3>
                            ...
                            {status === "completed" && estimation ? (
                                ...
                                >
                                    <div className="flex items-center gap-4 p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                                        ...
                                        <div>
                                            <h4 className="text-foreground font-bold">Scope Analysis Complete</h4>
                                            <p className="text-xs text-muted-foreground">Project parameters successfully modeled.</p>
                                        </div>
                                    </div>

                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 bg-foreground/5 border border-border rounded-xl space-y-1">
                                            <p className="text-[10px] text-muted-foreground uppercase font-mono flex items-center gap-1">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            {estimation.milestones.map((m, i) => (
                                                <div key={i} className="p-3 bg-foreground/[0.02] border border-border/50 rounded-lg group hover:border-cyan-500/30 transition-all">
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="bg-card rounded-2xl border border-border shadow-2xl overflow-hidden">
                {/* Terminal Header */}
                <div className="bg-foreground/5 px-4 py-3 border-b border-border/50 flex items-center justify-between">
                        ...
                        <div className="mt-8 pt-6 border-t border-border/50 flex justify-between items-center">
                            ...
                            {step === 4 ? (
                                ...
                                <Button
                                    ...
                                    className="bg-foreground/10 hover:bg-foreground/20 text-foreground border border-border font-mono px-8 h-10 group"
                                >
