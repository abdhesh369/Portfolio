    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 rounded-lg nm-inset border border-transparent space-y-4">
                    <h4 className="text-sm font-semibold text-purple-400">Primary CTA</h4>
                    <div className="space-y-2">
                        <label htmlFor="heroCtaPrimary" className="text-xs font-medium text-admin-text-secondary uppercase">Label</label>
                        <input id="heroCtaPrimary" {...register("heroCtaPrimary")} className="admin-input" />
                    </div>
                    <div className="space-y-2">
                        <label htmlFor="heroCtaPrimaryUrl" className="text-xs font-medium text-admin-text-secondary uppercase">URL / Hash</label>
                ...
                <div className="p-4 rounded-lg nm-inset border border-transparent space-y-4">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="heroCtaSecondary" className="text-xs font-medium text-admin-text-secondary uppercase">Label</label>
                        <input id="heroCtaSecondary" {...register("heroCtaSecondary")} className="admin-input" />
                    </div>
                    <div className="space-y-2">
                        <label htmlFor="heroCtaSecondaryUrl" className="text-xs font-medium text-admin-text-secondary uppercase">URL / Hash</label>
