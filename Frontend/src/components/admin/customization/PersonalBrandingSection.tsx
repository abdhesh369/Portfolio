        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                    <label htmlFor="personalName" className="text-xs font-medium text-admin-text-secondary uppercase">Full Name</label>
                    <input id="personalName" {...register("personalName")} className="admin-input" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                    <label htmlFor="personalTitle" className="text-xs font-medium text-admin-text-secondary uppercase">Professional Title</label>
                    <input id="personalTitle" {...register("personalTitle")} className="admin-input" placeholder="Software Engineer" />
                </div>
                <div className="md:col-span-2 space-y-2">
                    <label htmlFor="personalBio" className="text-xs font-medium text-admin-text-secondary uppercase">Bio</label>
                    <textarea id="personalBio" {...register("personalBio")} rows={3} className="admin-input resize-none" />
                </div>
                <div className="md:col-span-2 space-y-2">
                    <label htmlFor="personalAvatar" className="text-xs font-medium text-admin-text-secondary uppercase">Avatar URL</label>
