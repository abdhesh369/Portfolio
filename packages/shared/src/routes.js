import { z } from "zod";
import { projectSchema, skillSchema, skillConnectionSchema, experienceSchema, messageSchema, analyticsSchema, serviceSchema, insertProjectApiSchema, insertSkillApiSchema, insertExperienceApiSchema, insertMessageApiSchema, insertAnalyticsSchema, insertServiceApiSchema, testimonialSchema, insertTestimonialApiSchema, articleSchema, articleWithRelatedSchema, insertArticleApiSchema, seoSettingsSchema, insertSeoSettingsApiSchema, mindsetSchema, insertMindsetApiSchema, auditLogSchema, emailTemplateSchema, insertEmailTemplateApiSchema, guestbookSchema, insertGuestbookApiSchema, siteSettingsSchema, insertSiteSettingsApiSchema, } from "./schema.js";
// ==================== ERROR SCHEMAS ====================
