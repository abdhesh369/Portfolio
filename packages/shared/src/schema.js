...
export const projectsTable = pgTable("projects", {
    ...
    techStack: jsonb("techStack").$type().notNull(),
    imageUrl: varchar("imageUrl", { length: 500 }).notNull(),
    githubUrl: varchar("githubUrl", { length: 500 }),
    liveUrl: varchar("liveUrl", { length: 500 }),
    category: varchar("category", { length: 100 }).notNull(),
    displayOrder: integer("displayOrder").notNull().default(0),
    status: varchar("status", { length: 50 }).$type().notNull().default("Completed"),
...
export const skillsTable = pgTable("skills", {
    ...
    category: varchar("category", { length: 100 }).notNull(),
    status: varchar("status", { length: 100 }).$type().notNull().default("Core"),
...
export const analyticsTable = pgTable("analytics", {
    id: serial("id").primaryKey(),
    type: varchar("type", { length: 50 }).$type().notNull(), // page_view, project_view, contact_form
...
export const testimonialsTable = pgTable("testimonials", {
    ...
    relationship: varchar("relationship", { length: 100 }).$type().notNull().default("Colleague"),
...
export const auditLogTable = pgTable("audit_log", {
    id: serial("id").primaryKey(),
    action: varchar("action", { length: 20 }).$type().notNull(),
...
export const siteSettingsTable = pgTable("site_settings", {
    ...
    heroTaglines: jsonb("heroTaglines").$type().default(["Building amazing products", "Solving complex problems"]),
    // Hero CTAs
    ...
    navbarLinks: jsonb("navbarLinks").$type().default([]),
    ...
    sectionOrder: jsonb("sectionOrder").$type().default([...DEFAULT_SECTION_ORDER]),
    sectionVisibility: jsonb("sectionVisibility").$type().default({
...
export const ANALYTICS_EVENT_TYPES = ["page_view", "project_view", "contact_form", "resume_download", "vital"];
